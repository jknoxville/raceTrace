...
\section{Extra functionality for developmental purposes}
...
This describes the procedure as implemented, but it is possible to make it \emph{secure} with some, quite significant alterations.
